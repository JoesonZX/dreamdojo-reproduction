...
| run | mlp_action_r2 | mlp_action_l1 | mlp_action_max_l1 | mlp_action_r2_shuffled | action_r2_full_latent | labeleff_r2_10pct | labeleff_auc | action_knn_verb_top1 | action_knn_verb_maj5 | action_knn_chance | opp_cls_bal_acc | opp_cls_bal_acc_shuffled | opp_cls_n_tasks | ctrl_delta_psnr | ctrl_psnr_inferred | ctrl_psnr_random_action | collapse_flag |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kl_ft_l40_full_5k | 0.308 | 0.277 | 0.3763 | -0.03759 | 0.3434 | -0.2668 | -0.1897 | 0.04188 | 0.004332 | 0.07292 | 0.65 | 0.3929 | 1 | 1.025 | 34.7 | 33.68 | False |
| ours_a_zero_5k | 0.3257 | 0.2724 | 0.3799 | -0.03882 | 0.3629 | -0.135 | -0.09922 | 0.03755 | 0.002166 | 0.07292 | 0.775 | 0.3929 | 1 | 1.232 | 34.71 | 33.47 | False |
| ours_b2_zero_action_reverse_5k | 0.3267 | 0.2784 | 0.3916 | -0.041 | 0.3665 | -0.2041 | -0.09914 | 0.03466 | 0.001444 | 0.07292 | 0.775 | 0.3929 | 1 | 1.142 | 34.66 | 33.52 | False |
| ours_c_zero_reverse_hardneg_5k | 0.3321 | 0.2796 | 0.3763 | -0.05155 | 0.3658 | -0.08066 | -0.109 | 0.03321 | 0.000722 | 0.07292 | 0.7 | 0.5357 | 1 | 1.38 | 35 | 33.62 | False |
| ours_r_zero_opposite_5k | 0.3654 | 0.2686 | 0.3666 | -0.0449 | 0.4025 | -0.1341 | -0.0508 | 0.04188 | 0.005776 | 0.07292 | 0.675 | 0.4643 | 1 | 1.189 | 34.83 | 33.64 | False |
| ours_r2_opp_l01_5k | 0.3654 | 0.2692 | 0.3655 | -0.04768 | 0.402 | -0.1581 | -0.06839 | 0.04549 | 0.008664 | 0.07292 | 0.675 | 0.4643 | 1 | 1.234 | 34.82 | 33.59 | False |
...
- `opp_cls_bal_acc`: FAIR opposite-action test — within-task frozen logistic probe classifying
  the two reversible verbs (pull/push), mean balanced accuracy over `opp_cls_n_tasks` tasks
  (chance 0.5). `_shuffled` is a label-permutation control and MUST be ~0.5.
